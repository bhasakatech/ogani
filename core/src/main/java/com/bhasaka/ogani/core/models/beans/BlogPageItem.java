...
/**
 * POJO class representing a Blog Page item.
 * <p>
 * Contains blog page details such as title, description,
 * image, path, publish date, and raw date for pagination and sorting.
 */
public class BlogPageItem {
    ...
    /**
     * Constructor to initialize blog page item.
     *
