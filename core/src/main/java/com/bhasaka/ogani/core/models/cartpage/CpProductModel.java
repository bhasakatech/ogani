...
public class CpProductModel {
    ...
    private List<CpProduct> productList = new ArrayList<>();
    ...
    protected void init() {
        ...
        for (Resource item : products) {
            ...
            try {
                ...
                CpProduct product = new CpProduct();
                ...
                double currentPrice = vm.get("currentPrice", 0.0);
    ...
    public List<CpProduct> getProductList() {
        return productList;
    }
