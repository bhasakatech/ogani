        ...
        n.extend(e.Mixer.prototype, {
            ...
            sortOperation: function (t) {
                var a = this,
                    ...
                    s = -1;
                if (
                    (a.callActions("beforeSortOperation", arguments), (t.startOrder = a.targets), t.newSort.collection)
                ) {
            ...
            goMix: function (a, i) {
                ...
                return (
                    ...
                    (o.config.animation.duration && o.config.animation.effects && n.isVisible(o.dom.container)) ||
                        (a = !1),
            ...
            getOperation: function (t) {
                ...
                return (
                    ...
                    a.isBusy
                        ? (a.config.debug.showWarnings && console.warn(e.messages.warningGetOperationInstanceBusy()),
                          null)
            ...
            getState: function () {
                var t = this,
                    a = null;
                return (
                    (a = new e.State()), n.extend(a, t.state), n.freeze(a), t.callFilters("stateGetState", a, arguments)
                );
            },
